...
const PageHeaderTwo = ({ title, description, image, infoSessionUrl, price, categorys = [], trainers = [], courseId }) => {
    ...
    const fetchAverageRating = async () => {
        try {
            const response = await fetch(`http://localhost:4000/commentaire/comm/${courseId}/rating`);
                ...
                <div className="row justify-content-center justify-content-lg-between align-items-center flex-row-reverse">
                    <div className="col-lg-7 col-12">
                        <div className="pageheader-thumb">
                            <img
                                ...
                                alt={title}
                            />
                             <a className="video-button popup" target="_blank">
                            <i className="icofont-ui-play" onClick={handleVideoButtonClick}></i>
                            </a>
                        </div>
                    </div>
                    <div className="col-lg-5 col-12">
                        <div className="pageheader-content">
                            ...
                            <div className="phs-thumb" style={{ display: "flex", alignItems: "center" }}>
                                {trainers.length > 0 ? (
                                 ...
                                 <div className="course-reiew" style={{ marginLeft: "10px" }}>
                                    ...
                                    <span className="ratting-count">{formatRating(averageRating)} avis</span>
                                </div>
                            </div>
                        </div>
                    </div>
